...
if($fail > 0) { 
    ...
    <div id=\"researchFuture\" class=\"researches hide \">";
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">Academy</a><span class=\"level\"> level 10</span>, <a href=\"#\">Workshop</a><span class=\"level\"> szint 1</span></div></div><div class=\"clear\"></div></div><hr>";
     }
