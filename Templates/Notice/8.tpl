...
<?php } ?>
    ...
    <a href="spieler.php?uid=<?php echo $database->getUserField($dataarray[1],"id",0); ?>"><?php echo ($dataarray[1] == 0)? "Leleményes" : $database->getUserField($dataarray[1],"username",0); ?></a> <?php echo REPORT_FROM_VIL; ?><br>
