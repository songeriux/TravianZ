...
if (mysql_num_rows(mysql_query("SELECT id FROM ".TB_PREFIX."users WHERE access = 9 AND id = ".$session->uid)) != '1') die("Betörési kisérlet!");
...

{
	...
	if ($_POST['confirm'] == 'Yes'){
		...
		$fh = fopen($myFile, 'w') or die("<br/><br/><br/>Nem tudjuk megnyitni: templates/text.tpl");
...
<head>
	...
	<script src="new.js?0ac36" type="text/javascript"></script>
   	<link href="<?php echo GP_LOCATE; ?>lang/ir/compact.css?f4b7c" rel="stylesheet" type="text/css" />
   	<link href="<?php echo GP_LOCATE; ?>lang/ir/lang.css?f4b7c" rel="stylesheet" type="text/css" />
	<link href="gpack/travian_redesign/travian.css?f4b7c" rel="stylesheet" type="text/css" />
    <link href="gpack/travian_redesign/lang/ir/lang.css" rel="stylesheet" type="text/css" />
...
<form method="POST" action="sysmsg.php" name="myform" id="myform">
			...
			<table cellspacing="1" cellpadding="1" class="tbg" style="background-color:#C0C0C0; border: 0px solid #C0C0C0; font-size: 10pt;">    
			  ...
			  <tbody>
			    ...
			    <tr>	
			      ...
			      <td class="rbg" style="font-size: 10pt; text-align:center;">Rendszerüzenet</td>    
			...
			<textarea class="fm" name="message" cols="60" rows="23"></textarea></td>    
			    ...
			    <tr>	
			      ...
			      <td style="text-align:center;">Minden mezőt ki kell tölteni!</td>    
			    ...
			    <tr>	
			      ...
			      <td style="text-align:center;">
			        ...
			        <input type="submit" value="Küldés" name="submit" />    </td>
...
<a href="sysmsg.php?del">Régi rendszerüzenet törlése</a>
			...
			<table cellspacing="1" cellpadding="2" class="tbg">    
			  ...
			  <tbody>
			    ...
			    <tr>	
			      ...
			      <td class="rbg" colspan="2">Elfogadás</td>    

			    </tr>

			    <tr>	

			      <td style="text-align: left; width: 200px;">Biztos el akarod küldeni a rendszerüzenetet?</td>
...
Example: (BBCode - itt nem müködik!)
